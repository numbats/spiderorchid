...
mypubs_orcid <- fetch_orcid("0000-0001-6515-827X")
readr::write_rds(mypubs_orcid, here::here("data-raw/mjlorcid.rds"), compress = "bz2")
mypubs_scholar <- fetch_scholar("miNl6rMAAAAJ")
readr::write_rds(mypubs_scholar, here::here("data-raw/mjlscholar.rds"), compress = "bz2")
```

```{r readmypubs, echo=FALSE}
mypubs_orcid <- readr::read_rds(here::here("data-raw/mjlorcid.rds"))
mypubs_scholar <- readr::read_rds(here::here("data-raw/mjlscholar.rds"))
```
...
mypubs <- mypubs_scholar |>
  ...
  select(authors, year, title, journal, volume, issue, page, details, doi, citations)
```
